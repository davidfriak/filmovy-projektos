...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <?php if (session()->get('isLoggedIn')): ?>
        <a href="<?= site_url('popular/addForm') ?>" class="btn btn-success">
            Přidat populární film
        </a>
    <?php endif; ?>
</div>
    ...
    <?php foreach ($movies as $movie): ?>
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100 shadow-sm">
                ...
                <div class="bg-light d-flex align-items-center justify-content-center" style="height: 520px;">
                    <img
                        src="<?= base_url('uploads/posters/' . ($movie->poster ?: 'default.png')) ?>"
                        class="img-fluid"
                ...
                <?php if (session()->get('isLoggedIn')): ?>
                    <div class="card-footer">
                        <button
                            ...
                            data-bs-target="#deletePopularModal<?= $movie->pid_popular_movie ?>"
                        >
                            Smazat
                        </button>
                    </div>
