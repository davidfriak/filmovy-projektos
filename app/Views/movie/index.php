...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <?php if(session()->get('isLoggedIn')): ?>
        <a href="<?= base_url('/movies/addForm') ?>" class="btn btn-success">
            Přidat film
        </a>
    <?php endif; ?>
</div>
        ...
        <div class="col-md-4 mb-4">
            ...
            <div class="card h-100">
                ...
                <div class="card-footer">
                    ...
                    <a
                        href="<?= base_url('/movies/show/' . $movie->pid_movie) ?>"
                    ...
                    <?php if(session()->get('isLoggedIn')): ?>
                        ...
                        <a
                            href="<?= base_url('/movies/editForm/' . $movie->pid_movie) ?>"
        ...
        <div class="modal fade" id="deleteModal<?= $movie->pid_movie ?>" tabindex="-1">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <form
                        method="post"
                        action="<?= base_url('/movies/remove/' . $movie->pid_movie) ?>"
                    >
